  ...
  plugins: [
    ...
    new webpack.ProgressPlugin((percentage, msg, addInfo) => {
        ...
        if (stream.isTTY && percentage < 0.71) {
          stream.cursorTo(0);
          stream.write(`${chalk.green("treatSystem start compile......")}  ${chalk.magenta(msg)} (${chalk.magenta(addInfo)})`);
          stream.clearLine(1);
        } else if (percentage === 1) {
          console.log(chalk.green('\n-------------------biosan-TreatSystem-----------------'));
          console.log(chalk.green('webpack: treatSystem compile is now finished.\n'));
